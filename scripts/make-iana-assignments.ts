...
const createMappings = (curveLabels: [number, string][], paramsByKeyType: Map<any, any>, keyTypes: Map<any, any>, labelToAlgorithm: Map<number, string>) => {
...
(async () => {
  ...
  const mappings = createMappings(curveLabels, paramsByKeyType, keyTypes, labelToAlgorithm)
  const final = `
